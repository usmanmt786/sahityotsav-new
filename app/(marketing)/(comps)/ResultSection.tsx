    ...
    return (
        <div className="bg-primary">
            ...
            className="commonwidth py-20 grid lg:grid-cols-2">
              ...
              <h2 className="uppercase text-2xl font-bold"  data-aos="fade-up"  data-aos-delay="400">{APPCONFIGS.typeName} {APPCONFIGS.type}</h2>
              ...
              <div className=" mt-10 lg:mt-0 flex justify-center lg:justify-start">
                <img src="/images/result.png" className="w-[50vh] rounded-xl" alt="" />
              </div>
            </section>
        </div>
    );
