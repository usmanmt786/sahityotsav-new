    ...
    <div>
      ...
      >
        <PosterEditor
          ...
          x={posterConfigs.x}
          y={posterConfigs.y}
          imageUrl={`${Constants.DRIVE_URL}${poster?.file_name}`}
        ...
        <div className="mt-5 flex justify-center gap-x-5">
          <button className="outline-btn" onClick={deleteItem}>
            Delete
          </button>
          <button className=" bg-gbg btn text-white" onClick={handleSubmit}>
