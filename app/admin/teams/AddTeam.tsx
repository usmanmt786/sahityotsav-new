...
const AddTeam = () => {
    ...
    useSignalEffect(()=>{
        if(rowUpdateSignal.value && rowUpdateSignal.value.type==="team" && rowUpdateSignal.value.action=="add"){
            setShow(true)
    ...
    const formik  = useFormik({
        ...
        onSubmit:async(val)=>{
            ...
            const resp = await addTeam(val.name, val.code);
            if(resp.code===0){
