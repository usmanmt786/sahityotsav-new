...
const ImageUpload = (
    {id, labelText,cur,onChange, width, height}:
    {id:string,labelText:string, cur:any, onChange:any, width:number, height:number}) => {
...
const imgUrl  = isFile(cur) ? URL.createObjectURL(cur) : cur?.length>2?`${Constants.DRIVE_URL}uploads/site/${cur}`: null;
    return (
        <div className="my-2">
