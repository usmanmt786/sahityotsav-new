    ...
    const formik = useFormik({
        ...
        onSubmit:async(val)=>{
            ...
            if(brochure!=null && isFile(brochure)){
                ...
                const file = await uploadCustomizeImage(formData);
                fileName = file;
                setBrochure(file)
        ...
        <form onSubmit={formik.handleSubmit}>
           ...
           <div className="my-2">
            ...
            >
                ...
                {
                    brochure && isFile(brochure)? <div className="py-2">{brochure.name}</div>:
                    brochure && typeof brochure==="string" && brochure.length>5 ?
                    <div>
                        <h5 className=" font-light mt-2">{brochure}</h5>
                        <div className="py-1 my-1 border border-primary inline-block px-2">Change Brochure</div>
                        </div>:
                    <div>
            ...
            <ZSubmitButton loading={loading} loadText="Updating Brochure..." text="Update Brochure"/>
